/*This file was originaly created by Gabriele Romanato as a proof of concept. Modified by Nadia Tuchman*/
(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "nd-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "ndflower@gmail.com"; // Your Business PayPal's account email address
		...
		displayUserDetails: function() {
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-fname" ) == null ) {
					var fname = this.storage.getItem( "billing-fname" );
					var lname = this.storage.getItem( "billing-lname" );
					var email = this.storage.getItem( "billing-email" );
					var address1 = this.storage.getItem( "billing-address1" );
					var address2 = this.storage.getItem( "billing-address2" );
					...
					var sfName = this.storage.getItem( "shipping-fname" );
					var slName = this.storage.getItem( "shipping-lname" );
					var sEmail = this.storage.getItem( "shipping-email" );
					var sAddress1 = this.storage.getItem( "shipping-address1" );
					var sAddress2 = this.storage.getItem( "shipping-address2" );
					var sCountry = this.storage.getItem( "shipping-country" );					
					var sZip = this.storage.getItem( "shipping-zip" );
					var sPhone = this.storage.getItem( "shipping-phone" );
					...
					var html = "<div class='detail'>";
						...
						html += "<li>" + slName + "</li>";
						html += "<li>" + sEmail + "</li>";						
						html += "<li>" + sAddress1 + "</li>";
						html += "<li>" + sAddress2 + "</li>";
						html += "<li>" + sCountry + "</li>";
						html += "<li>" + sZip + "</li>";
						html += "<li>" + sPhone + "</li>";						
						html += "</ul></div>";
		...
		_saveFormData: function( form ) {
			...
			$visibleSet.each(function() {
				...
				if( $set.is( "#fieldset-billing" ) ) {
					var fname = $( "#fname", $set ).val();
					var lname = $( "#lname", $set ).val();
					var email = $( "#email", $set ).val();
					var address1 = $( "#address1", $set ).val();
					var address2 = $( "#address2", $set ).val();
					var zip = $( "#zip", $set ).val();
					var country = $( "#country", $set ).val();
					var phone = $( "#phone", $set ).val();
					
					self.storage.setItem( "billing-fname", fname );
					self.storage.setItem( "billing-lname", lname );
					self.storage.setItem( "billing-email", email );
					self.storage.setItem( "billing-address1", address1 );
					self.storage.setItem( "billing-address2", address2 );
					self.storage.setItem( "billing-zip", zip );
					self.storage.setItem( "billing-country", country );
					self.storage.setItem( "billing-phone", phone );
				} else {
					var sfName = $( "#sfname", $set ).val();
					var slName = $( "#slname", $set ).val();
					var sEmail = $( "#semail", $set ).val();
					var sAddress1 = $( "#saddress1", $set ).val();
					var sAddress2 = $( "#saddress2", $set ).val();
					var sZip = $( "#szip", $set ).val();
					var sCountry = $( "#scountry", $set ).val();
					var sPhone = $( "#sphone", $set ).val();
					
					self.storage.setItem( "shipping-fname", sfName );
					self.storage.setItem( "shipping-lname", slName );
					self.storage.setItem( "shipping-email", sEmail );					
					self.storage.setItem( "shipping-address1", sAddress1 );
					self.storage.setItem( "shipping-address2", sAddress2 );
					self.storage.setItem( "shipping-zip", sZip );
					self.storage.setItem( "shipping-country", sCountry );
					self.storage.setItem( "shipping-phone", sPhone );
